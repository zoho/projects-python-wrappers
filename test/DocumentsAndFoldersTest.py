...
try: 
    ...
    document.set_upload_doc(['/home/likewise-open/ZOHOCORP/chitra-pt101/Desktop/fil2.txt'])
    print documents_api.add(project_id, document)
    '''
    #Upload document

    document = Document()
    document.set_upload_doc(['/home/likewise-open/ZOHOCORP/chitra-pt101/Desktop/fil1.txt'])
