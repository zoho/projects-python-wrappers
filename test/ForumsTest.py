...
try:
    ...
    forum.set_upload_file(['/home/likewise-open/ZOHOCORP/chitra-2327/Desktop/fil1 .txt','/home/likewise-open/ZOHOCORP/chitra-2327/Desktop/fil2.txt'])
    ...
    forum.set_content("Forum content")
    forum.set_category_id(category_id)
    forum.set_upload_file('/home/likewise-open/ZOHOCORP/chitra-2327/Desktop/fil1.txt')
    forum.set_notify("1234")
